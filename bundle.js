...
function fetchCountries(term) {
  ...
  var countriesUrl = "https://restcountries.eu/rest/v2/name/".concat(term);
  console.log("countriesUrl", countriesUrl);
  return new Promise(function (resolve) {
    _axios["default"].get(countriesUrl).then(function (response) {
...
},{"./setup":31}],31:[function(require,module,exports){
"use strict";
...
var _countries = _interopRequireDefault(require("./views/countries"));
...
function setup() {
  ...
  searchInput.addEventListener("keydown", function (event) {
    ...
    (0, _data["default"])(enteredText).then(function (countriesArray) {
      console.log("*******", countriesArray);
      var countriesList = (0, _countries["default"])(countriesArray);
...
},{"./data":29,"./views/countries":32,"./views/layout":33,"./views/loader":34}],32:[function(require,module,exports){
"use strict";
...
function countries(cntArray) {
  ...
  for (var i = 0; i < cntArray.length; i++) {
    listItems += "<li>".concat(cntArray[i].name, " - ").concat(cntArray[i].capital, " - ").concat(cntArray[i].region, "</li>");
  }
